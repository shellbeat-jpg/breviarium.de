...
// * DIR_WS_* = Webserver directories (virtual/URL)
  ...
  define('DIR_WS_CATALOG', '/xtcmodified-1.05/'); // absolute path required
  define('DIR_FS_DOCUMENT_ROOT', 'C:/wamp/www/xtcmodified-1.05/');
  define('DIR_FS_CATALOG', 'C:/wamp/www/xtcmodified-1.05/');
